...
import { GeminiOmniStudioV2 } from '@/components/v2/GeminiOmniStudioV2';
import { WeclappErpEngineV2 } from '@/components/v2/WeclappErpEngineV2';
import { LboGenehmigungCheckerV2 } from '@/components/v2/LboGenehmigungCheckerV2';
import { StatikZertifikatViewerV2 } from '@/components/v2/StatikZertifikatViewerV2';
import { MontageAblaufV2 } from '@/components/v2/MontageAblaufV2';
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-slate-100 font-sans selection:bg-amber-500 selection:text-slate-950 pb-24 lg:pb-10">
      ...
      <main className="space-y-24 py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <ConfiguratorV2 />
        <LboGenehmigungCheckerV2 />
        <StatikZertifikatViewerV2 />
        <MontageAblaufV2 />
        <GeminiOmniStudioV2 />
