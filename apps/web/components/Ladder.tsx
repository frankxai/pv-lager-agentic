...
const stufen = [
  ...
  },
  {
    ...
    body: 'Beschaffung, Montage, Netzanmeldung und Inbetriebnahme. Ausgeführt durch die RIAL Energy GmbH mit eigenem Zentrallager in Seesen und Meisterbetrieb VR Gebäudetechnik.',
    detail: 'Auf Wunsch mit anschließender Betriebsführung und Wartung.',
    href: '/realisierung',
    cta: 'Ablauf ansehen',
  },
];
