...
export function MobileStickyBarV2({ onOpenLeadMagnet, onOpenCopilot }: MobileStickyBarV2Props) {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden bg-[#070B14]/95 backdrop-blur-3xl border-t border-amber-500/40 p-2.5 shadow-2xl px-4">
      <div className="grid grid-cols-4 gap-2 items-center text-center">
        <a
          href="#configurator-v2"
          className="flex flex-col items-center justify-center p-2 rounded-xl bg-gradient-to-br from-amber-400 via-amber-500 to-amber-600 text-slate-950 font-bold active:scale-95 transition shadow-lg"
        >
          <Zap className="w-4 h-4 fill-current mb-0.5" />
          <span className="text-[10px] font-mono uppercase tracking-tight">3D Planer</span>
        </a>
        ...
        >
          ...
          <span className="text-[10px] font-mono uppercase tracking-tight">Direktruf</span>
        </a>
        ...
        >
          ...
          <span className="text-[10px] font-mono uppercase tracking-tight">Concierge</span>
        </button>
        ...
        >
          ...
          <span className="text-[10px] font-mono uppercase tracking-tight">Leitfaden</span>
        </button>
      </div>
    </div>
  );
