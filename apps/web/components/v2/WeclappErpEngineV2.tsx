...
import { Database, FileText, CheckCircle, ShieldCheck, Download, Zap } from 'lucide-react';
...
export function WeclappErpEngineV2() {
  ...
  return (
    <section className="w-full max-w-7xl mx-auto my-16 px-4 sm:px-6">
      <div className="bg-[#000000] border border-amber-500/30 rounded-3xl p-8 sm:p-12 shadow-2xl space-y-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-white/10 pb-8">
          <div>
            <span className="text-xs font-sans uppercase text-amber-400 tracking-widest font-medium flex items-center gap-2">
              ...
              Automatisierte ERP Angebote &amp; Stücklisten
            </span>
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-white mt-1">
              Weclapp ERP Live-Kalkulation &amp; BOM Engine
            </h2>
          </div>
          <div className="px-3.5 py-1.5 rounded-full bg-emerald-500/15 text-emerald-300 border border-emerald-500/30 text-xs font-sans font-medium">
        ...
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-6 space-y-6">
            <div className="space-y-2">
              <h3 className="font-serif font-bold text-xl text-white">Echtzeit Weclapp ERP Stücklisten-Erzeugung</h3>
              <p className="text-xs text-slate-300 leading-relaxed font-normal">
                Transparente Berechnung aller Komponenten aus dem Zentrallager Seesen: Aluminium-Legierung 6063-T6, Trina Glas-Glas PV-Eindeckung, BYD Speicher und Befestigungs-Set.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-slate-950/80 border border-white/10 space-y-3 text-xs font-sans">
              <div className="flex justify-between items-center text-slate-300 border-b border-white/10 pb-2">
                <span>Alu Carport-Tragwerk 100x100mm (Zola Pod):</span>
              ...
              <div className="flex justify-between items-center text-slate-300 border-b border-white/10 pb-2">
                <span>BYD Battery-Box HVS 10.2 kWh:</span>
            ...
            >
              ...
              <span>{loading ? 'Generiere ERP Angebot...' : 'Offizielles Weclapp ERP Angebot PDF erstellen'}</span>
            </button>
          </div>
            ...
            {quoteGenerated ? (
              <div className="bg-slate-950/90 border border-emerald-500/30 rounded-3xl p-8 space-y-6 shadow-2xl animate-in fade-in">
                <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                  ...
                  <div>
                    <h4 className="font-bold text-white text-base">ERP Angebot erfolgreich erstellt</h4>
                    <span className="text-xs text-slate-400 font-mono">BOM-SEESEN-{Math.floor(100000 + Math.random() * 900000)}</span>
                  </div>
                </div>

                <p className="text-xs text-slate-300 leading-relaxed font-sans">
                  Ihr individuelles Angebot liegt abrufbereit vor. Alle Posten sind aus dem Zentrallager Seesen vorreserviert.
                </p>

                <div className="p-4 rounded-2xl bg-black border border-white/10 space-y-2 text-xs">
                  <div className="flex justify-between text-slate-400">
                    <span>Gültigkeit:</span>
                    <span className="text-white font-mono">14 Tage Garantie</span>
                  </div>
                  <div className="flex justify-between text-slate-400">
                    <span>Speditionsversand:</span>
                    <span className="text-emerald-400 font-mono">Gratis in DE</span>
                  </div>
                </div>
              ...
              <div className="bg-slate-950/60 border border-white/10 rounded-3xl p-8 text-center space-y-4 backdrop-blur-xl">
                ...
                <h4 className="font-bold text-white text-base">Vorschau für ERP Angebot</h4>
                <p className="text-xs text-slate-400 max-w-sm mx-auto">
                  Klicken Sie auf den Button links, um ein rechtskonformes Weclapp ERP PDF-Angebot inkl. Steuerfreistellung zu erzeugen.
                </p>
              </div>
            )}
          </div>
