...
import { Camera, Sparkles, Cpu, CheckCircle2, RefreshCw, Layers, ShieldAlert, ArrowRight } from 'lucide-react';

export function GeminiOmniStudioV2() {
  const [scanning, setScanning] = useState(false);
  const [analyzed, setAnalyzed] = useState(false);
  const [activeTab, setActiveTab] = useState<'vision' | 'twin' | 'erp'>('vision');
  ...
  return (
    <section className="w-full max-w-7xl mx-auto my-16 px-4 sm:px-6">
      <div className="bg-[#000000] border border-[#10B981]/30 rounded-3xl p-8 sm:p-12 shadow-2xl space-y-10">
        {/* Header */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-white/10 pb-8">
          <div>
            <span className="text-xs font-sans uppercase text-emerald-400 tracking-widest font-medium flex items-center gap-2">
              ...
              Multimodales KI-Inspektions System
            </span>
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-white mt-1">
              Gemini Omni Vision &amp; Spatial Digital Twin
            </h2>
          </div>
          <div className="flex items-center gap-2">
            <span className="px-3.5 py-1.5 rounded-full bg-emerald-500/15 text-emerald-300 border border-emerald-500/30 text-xs font-sans font-medium">
              Gemini 2.0 Flash Spatial Vision Engine
            </span>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="space-y-2">
              <h3 className="font-serif font-bold text-xl text-white">Automatischer Anwesens-Scan via Smartphone-Kamera</h3>
              <p className="text-xs text-slate-300 leading-relaxed font-normal">
                Kamera auf die Einfahrt oder Terrasse richten. Unsere Vision Engine erkennt Fundament-Klasse, Neigungswinkel und Schattenwurf in unter 2 Sekunden.
              </p>
            </div>
            ...
            >
              {scanning ? (
                ...
                <>
                  ...
                  <span>Kamera-Standort-Scan jetzt simulieren</span>
                </>
              )}
            </button>
              ...
              <div className="p-6 rounded-2xl bg-slate-950 border border-emerald-500/30 space-y-3 font-sans text-xs animate-in fade-in">
                <div className="flex items-center justify-between text-emerald-400 font-medium border-b border-white/10 pb-2">
                  <span className="flex items-center gap-1.5">
                    ...
                    Scan Ergebnis: Perfekt geeignet
                  </span>
                ...
                <div className="space-y-1.5 text-slate-300">
                  <div className="flex justify-between">
                    ...
                    <strong className="text-white">Beton-Punktfundament (80x80cm)</strong>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    <span>Optimales Carport-System:</span>
                    <strong className="text-emerald-400">Zola Pod Doppel-Carport</strong>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="relative rounded-3xl overflow-hidden border border-white/10 bg-slate-950 shadow-2xl p-2">
              <div className="relative h-80 rounded-2xl overflow-hidden border border-white/10 bg-black">
                  ...
                  <div className="absolute inset-0 bg-emerald-500/10 flex items-center justify-center backdrop-blur-sm">
                    <div className="text-center space-y-2">
                      ...
                      <span className="text-xs font-mono text-emerald-300 bg-black/80 px-3 py-1 rounded-full border border-emerald-500/30">
                        Spatial Point Cloud Processing...
                      </span>
                    </div>
                  </div>
                )}
                ...
                <div className="absolute bottom-3 left-3 px-3 py-1 rounded-full bg-black/80 backdrop-blur border border-white/10 text-xs font-sans text-slate-300">
                  Live Vision Stream · 30 FPS Spatial Mesh
                </div>
              </div>
            </div>
          </div>
